...
import rospy
from hrwros_msgs.msg import SensorInformation, BoxHeigthInformation
...
def sensor_info_callback(data, bhi_pub):
    ...
    if height_box<2:
        ...
        box_height_info = BoxHeigthInformation()
...
if __name__ == '__main__':
    ...
    bhi_publisher = rospy.Publisher('box_height_info', BoxHeigthInformation, queue_size=10)
